...
public class FABIcon extends ImageButton {
    ...
    public FABIcon(Context context) {
        this(context, null);
    }

    public FABIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FABIcon(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mVisible = true;
        mColorNormal = getColor(R.color.fab_icon_bg);
